"""
Django settings for bhd_38558 project.
...
WSGI_APPLICATION = 'bhd_38558.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "bhd_38558 API",
    "DESCRIPTION": "API documentation for bhd_38558 App",
    "VERSION": "v1",
}
